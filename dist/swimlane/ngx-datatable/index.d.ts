...
declare class DataTableColumnDirective<TRow extends Row> implements TableColumn, OnChanges {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    never,
    {
      ...
      '_treeToggleTemplateInput': { 'alias': 'treeToggleTemplate'; 'required': false };
...
interface StandardTableColumnInternal<TRow extends Row = any>
  extends BaseTableColumnInternal<TRow> {
  sortable?: false;
}
interface SortableTableColumnInternal<TRow extends Row = any>
  extends BaseTableColumnInternal<TRow> {
  comparator: Exclude<TableColumn['comparator'], undefined>;
  prop: TableColumnProp;
  sortable: true;
}
type TableColumnInternal<TRow extends Row = any> =
...
declare class DataTableBodyRowComponent<TRow extends Row = any> implements DoCheck, OnChanges {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    never,
    {
      ...
      'verticalScrollVisible': { 'alias': 'verticalScrollVisible'; 'required': false };
...
declare class DataTableBodyComponent<TRow extends Row = any> implements OnInit, OnDestroy {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    never,
    {
      ...
      'ghostLoadingIndicator': { 'alias': 'ghostLoadingIndicator'; 'required': false };
      ...
      'groupExpansionDefault': { 'alias': 'groupExpansionDefault'; 'required': false };
      'innerWidth': { 'alias': 'innerWidth'; 'required': false };
...
declare class DataTableHeaderComponent implements OnDestroy, OnChanges {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    never,
    {
      ...
      'enableClearingSortState': { 'alias': 'enableClearingSortState'; 'required': false };
      'innerWidth': { 'alias': 'innerWidth'; 'required': false };
...
declare class DatatableComponent<TRow extends Row = any>
...
declare class DatatableRowDefInternalDirective implements OnInit {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    never,
    {
      'rowDefInternal': { 'alias': 'rowDefInternal'; 'required': false };
      'rowDefInternalDisabled': { 'alias': 'rowDefInternalDisabled'; 'required': false };
    },
    {},
    never,
    never,
...
declare class NgxDatatableModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    ...
    never,
    [
      typeof DataTableFooterTemplateDirective,
      typeof DatatableComponent,
      typeof DataTableColumnDirective,
      typeof DatatableRowDetailDirective,
      typeof DatatableGroupHeaderDirective,
      typeof DatatableRowDetailTemplateDirective,
      typeof DataTableColumnHeaderDirective,
      typeof DataTableColumnCellDirective,
      typeof DataTableColumnGhostCellDirective,
      typeof DataTableColumnCellTreeToggle,
      typeof DatatableFooterDirective,
      typeof DatatableGroupHeaderTemplateDirective,
      typeof DisableRowDirective,
...
declare function toInternalColumn<T extends Row>(
...
export type {
  ActivateEvent,
  AllDetailToggleEvent,
  AllGroupsToggleEvent,
  BaseTableColumnInternal,
  CellActiveEvent,
  CellContext,
  ColumnGroupWidth,
  ColumnResizeEvent,
  ColumnResizeEventInternal,
  ContextMenuEvenHeader,
  ContextMenuEvent,
